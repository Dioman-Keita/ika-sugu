...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    "account.orders.detail.title": "Order Detail",
    "account.orders.detail.back": "Back to my orders",
    "account.orders.detail.orderInfo": "Order Information",
    "account.orders.detail.shippingAddress": "Shipping Address",
    "account.orders.detail.noShippingAddress": "No delivery address available.",
    "account.orders.detail.summary": "Summary",
    "account.orders.detail.subtotal": "Subtotal",
    "account.orders.detail.total": "Total",
    ...
    "admin.overview.table.pageOf": "Page {current} of {total}",
    ...
    "admin.orders.detail.back": "Back to orders",
    "admin.orders.detail.customerInfo": "Customer Information",
    "admin.orders.detail.shippingAddress": "Shipping Address",
    "admin.orders.detail.orderSummary": "Order Summary",
    "admin.orders.detail.status": "Status",
    "admin.orders.detail.date": "Order date",
    "admin.orders.detail.subtotal": "Subtotal",
    "admin.orders.detail.vat": "VAT",
    "admin.orders.detail.total": "Total",
    "admin.orders.detail.payment": "Payment Information",
    "admin.orders.detail.stripeId": "Stripe Session",
    ...
    "admin.orders.detail.conversion": "Currency conversion",
    "admin.orders.detail.originalPrice": "Original unit price",
    "admin.orders.detail.exchangeRate": "Exchange rate",
    "admin.orders.detail.noConversion": "No conversion (same currency)",
    "admin.orders.detail.targetCurrency": "Target currency at purchase",
    "admin.orders.detail.vatRate": "VAT rate",
  ...
  fr: {
    ...
    "account.orders.detail.title": "Détail de la commande",
    "account.orders.detail.back": "Retour à mes commandes",
    "account.orders.detail.orderInfo": "Informations commande",
    "account.orders.detail.shippingAddress": "Adresse de livraison",
    "account.orders.detail.noShippingAddress": "Aucune adresse de livraison disponible.",
    "account.orders.detail.summary": "Récapitulatif",
    "account.orders.detail.subtotal": "Sous-total",
    "account.orders.detail.total": "Total",
    ...
    "admin.overview.table.date": "Date",
    "admin.overview.table.pageOf": "Page {current} sur {total}",
    ...
    "admin.orders.detail.title": "Détail de la commande #{id}",
    "admin.orders.detail.back": "Retour aux commandes",
    "admin.orders.detail.customerInfo": "Informations client",
    "admin.orders.detail.shippingAddress": "Adresse de livraison",
    "admin.orders.detail.orderSummary": "Récapitulatif",
    "admin.orders.detail.status": "Statut",
    "admin.orders.detail.date": "Date de commande",
    "admin.orders.detail.subtotal": "Sous-total",
    "admin.orders.detail.vat": "TVA",
    "admin.orders.detail.total": "Total",
    "admin.orders.detail.payment": "Paiement",
    "admin.orders.detail.stripeId": "Session Stripe",
    "admin.orders.detail.items": "Articles",
    "admin.orders.detail.sku": "SKU",
    "admin.orders.detail.quantity": "Qté",
    "admin.orders.detail.price": "Prix",
    "admin.orders.detail.conversion": "Conversion de devise",
    "admin.orders.detail.originalPrice": "Prix unitaire d'origine",
    "admin.orders.detail.exchangeRate": "Taux de change",
    "admin.orders.detail.noConversion": "Pas de conversion (même devise)",
    "admin.orders.detail.targetCurrency": "Devise cible à l'achat",
    "admin.orders.detail.vatRate": "Taux de TVA",
